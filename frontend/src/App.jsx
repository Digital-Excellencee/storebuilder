...
function DashboardBulkUploadPage() {
  ...
  async function importCsv(event) {
    ...
    try {
      ...
      const result = await api.post('/api/dashboard/bulk-upload/import', { csvText }, token);
